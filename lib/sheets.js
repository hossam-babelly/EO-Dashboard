...
const TAB = process.env.SHEET_TAB || 'الملخص التنفيذي'; // تبويب البروفايل الأول (الافتراضي)
...
async function createProfileTab(tabName) {
  ...
  // نسخ بنية الجدول (صفوف العناوين/الترويسة حتى صف العناوين) من التبويب الأول
